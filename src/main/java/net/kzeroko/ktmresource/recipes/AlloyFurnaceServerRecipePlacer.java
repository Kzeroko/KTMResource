...
public class AlloyFurnaceServerRecipePlacer<C extends Container> implements PlaceRecipe<Integer> {
    ...
    public AlloyFurnaceServerRecipePlacer(RecipeBookMenu<C> recipeBookContainer) {
