...
public class AquaslashkaiA extends SwordItem {
    public AquaslashkaiA(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        if (Screen.hasShiftDown()) {
            pTooltipComponents.add(new TranslatableComponent("desc.ktmresource.aquaslashkai_a").withStyle(KtmItemDesc.DESCRIPTION));
        }
    }
}
