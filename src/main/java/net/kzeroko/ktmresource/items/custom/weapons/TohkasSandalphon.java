...
public class TohkasSandalphon extends SwordItem {
    public TohkasSandalphon(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        if (Screen.hasShiftDown()) {
            pTooltipComponents.add(new TranslatableComponent("desc.ktmresource.tohkas_sandalphon").withStyle(KtmItemDesc.DESCRIPTION));
        }
    }
}
