...
public class CharonsGuidance extends SwordItem {
    public CharonsGuidance(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        if (Screen.hasShiftDown()) {
            pTooltipComponents.add(new TranslatableComponent("desc.ktmresource.charons_guidance").withStyle(KtmItemDesc.DESCRIPTION));
        }
    }
}
